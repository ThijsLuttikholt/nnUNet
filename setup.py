...
setup(name='nnunet',
      ...
      entry_points={
          'console_scripts': [
              ...
              'nnUNet_predict = nnunet.inference.predict_simple:helper',
              ...
              'nnUNet_diag_generate_unet_weightmaps = nnunet.utils.diag.generate_unet_weightmaps:generate_unet_weightmaps_cli',
          ],
      },
